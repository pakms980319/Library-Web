...
<body>
    <div id="body-wrap">
        ...
        <!-- main 회원가입/로그인박스 선택 페이지================================================================================================================================ -->
            <div id="main">
          
              <div id="login_form">
                <h1>로그인/회원가입</h1>
                <div>
                    <b style="font-size:14px; color:#0e0343">아이디</b><br>
                    <input id="loginId" type="text" required>
                </div>
                <div> 
                    <b style="font-size:14px; color:#0e0343">비밀번호</b><br>
                    <input id="loginPassword" type="password" required>
                </div>
                  <div>
                      <a href="findId.php" style="float:left; margin-left: 30px">아이디 찾기</a>
                      <a href="findPw.php" style="margin-left: 30px; margin-right: 30px">비밀번호 찾기</a>
                  </div>
       
                
                <button id="login" type="submit" onclick="login()">로그인</button>
                <div></div><button id="join" type="submit" onclick="location.href = 'join1.php'">회원가입</button>

              </div>
                  
            </div>
        </div>
        <script src="./js/join+login.js"></script>
