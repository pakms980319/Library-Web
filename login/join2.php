        ...
        <div id="input_info">
               ...
               <div>
                <label for="name">이름 </label>
                    ...
                    <div id="noti_name"><b>*2자 이상의 한글만 입력</b></div>
                </div>
                <div >
                     <label for="id">ID </label>
                    <input id="id" type="text" >
                    <button type="button" id="check" onclick="checkDuplicate()">ID 중복 확인</button>
                    <div id="noti_id"><b>*4-16자의 대소문자 또는 숫자 입력</b></div>
                </div>
                <div >
                    <label for="password">비밀번호 </label>
                    <input id="password" type="password" >
                    <div id="noti_pw"><b>*4-16자의 대소문자 또는 숫자 입력</b></div>
                </div>
                <div>
                     <label for="password">비밀번호 확인 </label>
                    <input id="passwordch" type="password" >
                    <div id="noti_pwch"><b>*비밀번호와 동일하게 입력</b></div>
                </div>
                <div>
                   <label for="phone">전화번호 </label>
                    <input id="phone" type="tel"> 
                    <div id="phone_eg">형식 : 010-1234-5678</div>
            ...
            <div id="signup-container">
                <button id="signup" type="submit" onclick="signup()">가입하기</button>
            </div>
